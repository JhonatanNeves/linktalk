package com.example.linktalk.service
...
import com.example.linktalk.LinkTalkApp
...
import com.example.linktalk.data.util.NotificationPayloadParse
import com.example.linktalk.model.NotificationData
import com.example.linktalk.navigation.CHAT_BASE_DETAIL_URI
...
class FcmMessagingService : FirebaseMessagingService() {
        ...
        scope.launch {
            ...
            if (selfUser?.id != null) {
                ...
                notificationPayloadJsonString?.let { payloadString ->
                    ...
                    if (LinkTalkApp.onAppForeground) {
    ...
    private fun sendNotification(notificationData: NotificationData) {
        ...
        val notificationBuilder = NotificationCompat.Builder(applicationContext, LinkTalkApp.CHAT_MESSAGES_CHANNEL_ID)
